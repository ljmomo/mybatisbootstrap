...
<script type="text/javascript">
	...
	function hasU(){
		...
		var url = "happuser/hasU.do?USERNAME="+USERNAME+"&tm="+new Date().getTime();
	...
	function hasE(USERNAME){
		var EMAIL = $("#EMAIL").val();
		var url = "happuser/hasE.do?EMAIL="+EMAIL+"&USERNAME="+USERNAME+"&tm="+new Date().getTime();
		$.get(url,function(data){
			if(data=="error"){
	...
	function hasN(USERNAME){
		...
		var url = "happuser/hasN.do?NUMBER="+NUMBER+"&USERNAME="+USERNAME+"&tm="+new Date().getTime();
		$.get(url,function(data){
			if(data=="error"){
